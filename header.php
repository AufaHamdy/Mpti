...
?>
				...
				<ul class="menu-list">
					...
					<li><a href="katalog.php"><i class="fa fa-th"></i> Katalog</a></li>
					<li><a href="tentang.php"><i class="fa fa-info-circle"></i> Tentang Kami</a></li>
					<li><a href="login.php"><i class="fa fa-lock"></i> Admin</a></li>
				</ul>
				</div>
				<!-- menu nav -->
			</div>

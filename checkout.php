								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="form-group">
											...
											<select name='provinsi' id='provinsi' class="input" required="required">
												...
												if($data_provinsi && isset($data_provinsi['rajaongkir']['results'])){
													for ($i=0; $i < count($data_provinsi['rajaongkir']['results']); $i++) {
														echo "<option value='".$data_provinsi['rajaongkir']['results'][$i]['province']."'>".$data_provinsi['rajaongkir']['results'][$i]['province']."</option>";
													}
												}
												?>
											</select>
										...
										<div class="form-group">
											...
											<input type="text" class="input" name="kabupaten" placeholder="Masukkan kabupaten/kota .." required="required">
										</div>

										<!-- Hidden input tidak diperlukan lagi -->
										<!-- 
										<input name="kurir" id="kurir" value="" type="hidden">
										<input name="ongkir2" id="ongkir2" value="" type="hidden">
										<input name="service" id="service" value="" type="hidden">
										<input name="provinsi2" id="provinsi2" value="" type="hidden"> 
										<input name="kabupaten2" id="kabupaten2" value="" type="hidden"> 
										<input name="berat" id="berat2" value="" type="hidden">
										-->
								...
								if(isset($_SESSION['keranjang'])){
									...
									if($jumlah_isi_keranjang != 0){
										...
										<table class="shopping-cart-table table">
											...
											<tfoot>
												<!-- Hapus baris total berat dan ongkir -->
												<!-- 
												<tr>
